---
title: Uso de tipografía e imágenes en Bootstrap
...
head:
  - tag: title
    content: Uso de Tipografía con Bootstrap · Bootstrap en Español v5.3
sidebar:
  label: Tipografías e imágenes
---
...
<DemoIframe path="/demos/bootstrap/5.3/content/typography/headings.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/content/typography/customizing-headings.html" >
```html title="HTML"
<h3>
...
<DemoIframe path="/demos/bootstrap/5.3/content/typography/display-headings.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/content/typography/lead.html" >
```html title="HTML"
    <p class="lead">
...
<DemoIframe path="/demos/bootstrap/5.3/content/typography/inline-text-elements.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/content/typography/abbreviations.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/content/typography/blockquotes.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/content/typography/naming-a-source.html" >
```html title="HTML"
    <figure>
        <blockquote class="blockquote">
            <p>Una cita muy conocida, contenida en un elemento blockquote.</p>
...
<DemoIframe path="/demos/bootstrap/5.3/content/typography/alignment-1.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/content/typography/alignment-2.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/content/typography/unstyled.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/content/typography/inline.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/content/typography/description-list-alignment.html" >
```html title="HTML"
    <dl class="row">
...
<DemoIframe path="/demos/bootstrap/5.3/content/images/responsive-images.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/content/images/image-thumbnails.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/content/images/aligning-images-1.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/content/images/aligning-images-2.html" >
```html title="HTML"
    <img src="..." class="rounded mx-auto d-block" alt="...">
```
</DemoIframe>

<DemoIframe path="/demos/bootstrap/5.3/content/images/aligning-images-3.html" >
```html title="HTML"
