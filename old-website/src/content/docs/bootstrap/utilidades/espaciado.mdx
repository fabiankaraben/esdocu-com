---
title: Uso de las utilidades de Espaciado en Bootstrap
...
head:
  - tag: title
    content: Uso de las utilidades de Espaciado en Bootstrap · Bootstrap en Español v5.3
sidebar:
  label: Utilidades de espaciado
---
...
<DemoIframe path="/demos/bootstrap/5.3/utilities/spacing/horizontal-centering.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/utilities/spacing/gap.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/utilities/spacing/row-gap.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/utilities/spacing/column-gap.html" >
```html title="HTML"
