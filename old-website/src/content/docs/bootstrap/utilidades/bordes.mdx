---
title: Uso de las utilidades de Bordes en Bootstrap
...
head:
  - tag: title
    content: Uso de las utilidades de Bordes en Bootstrap · Bootstrap en Español v5.3
sidebar:
  label: Utilidades de bordes
---
...
<DemoIframe path="/demos/bootstrap/5.3/utilities/borders/additive.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/utilities/borders/subtractive.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/utilities/borders/color-1.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/utilities/borders/color-2.html" >
```html title="HTML"
    <div class="mb-4">
...
<DemoIframe path="/demos/bootstrap/5.3/utilities/borders/example-1.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/utilities/borders/example-2.html" >
```html title="HTML"
    <div class="border border-success p-2 mb-2">Este es el borde de éxito predeterminado</div>
...
<DemoIframe path="/demos/bootstrap/5.3/utilities/borders/width.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/utilities/borders/radius.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/utilities/borders/sizes-1.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/utilities/borders/sizes-2.html" >
```html title="HTML"
...
```scss title="scss/mixins/_border-radius.scss"
