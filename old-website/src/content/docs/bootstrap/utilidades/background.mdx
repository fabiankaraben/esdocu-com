---
title: Uso de las utilidades de Background en Bootstrap
description: Transmite significado a través del color de fondo y agrega decoración con degradados.
head:
  - tag: title
    content: Uso de las utilidades de Background en Bootstrap · Bootstrap en Español v5.3
sidebar:
  label: Utilidades de background
---
...
<DemoIframe path="/demos/bootstrap/5.3/utilities/background/background-color.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/utilities/background/background-gradient.html" >
</DemoIframe>
...
<DemoIframe path="/demos/bootstrap/5.3/utilities/background/example-1.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/utilities/background/example-2.html" >
```html title="HTML"
    <div class="bg-success p-2 text-white">Este es el fondo de éxito predeterminado</div>
...
```scss title="scss/mixins/_gradients.scss"
