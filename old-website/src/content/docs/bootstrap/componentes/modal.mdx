---
title: El componente Modal de Bootstrap
...
head:
  - tag: title
    content: El componente Modal de Bootstrap · Bootstrap en Español v5.3
sidebar:
  label: Modal
---
...
<DemoIframe path="/demos/bootstrap/5.3/components/modal/modal-components.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/modal/live-demo.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/modal/static-backdrop.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/modal/scrolling-long-content-1.html" >
</DemoIframe>
...
<DemoIframe path="/demos/bootstrap/5.3/components/modal/scrolling-long-content-2.html" >
```html title="HTML"
<!-- Scrollable modal -->
...
<DemoIframe path="/demos/bootstrap/5.3/components/modal/vertically-centered.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/modal/tooltips-and-popovers.html" >
```html title="HTML"
<div class="modal-body">
...
<DemoIframe path="/demos/bootstrap/5.3/components/modal/using-the-grid.html" >
```html title="HTML"
<div class="modal-body">
...
<DemoIframe path="/demos/bootstrap/5.3/components/modal/varying-modal-content.html" >
```html title="HTML"
...
```scss title="site/assets/js/snippets.js"
...
<DemoIframe path="/demos/bootstrap/5.3/components/modal/toggle-between-modals.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/modal/optional-sizes.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/modal/fullscreen-modal.html" >
```html title="HTML"
<!-- Full screen modal -->
