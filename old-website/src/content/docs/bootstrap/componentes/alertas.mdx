---
title: El componente Alerta de Bootstrap
...
head:
  - tag: title
    content: El componente Alerta de Bootstrap · Bootstrap en Español v5.3
sidebar:
  label: Alertas
---
...
<DemoIframe path="/demos/bootstrap/5.3/components/alerts/examples.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/alerts/live-example.html" >
```html title="HTML"
...
```javascript title="site/assets/js/snippets.js"
...
<DemoIframe path="/demos/bootstrap/5.3/components/alerts/link-color.html" >
```html title="HTML"
    <div class="alert alert-primary" role="alert">
...
<DemoIframe path="/demos/bootstrap/5.3/components/alerts/additional-content.html" >
```html title="HTML"
    <div class="alert alert-success" role="alert">
...
<DemoIframe path="/demos/bootstrap/5.3/components/alerts/icons-1.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/alerts/icons-2.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/alerts/dismissing.html" >
```html title="HTML"
...
```scss title="scss/mixins/_alert.scss"
