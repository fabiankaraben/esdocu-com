...
<DemoIframe path="/demos/bootstrap/5.3/components/toasts/basic.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/toasts/live-example.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/toasts/translucent.html" >
```html title="HTML"
<div class="toast fade show" role="alert" aria-live="assertive" aria-atomic="true">
    <div class="toast-header">
...
<DemoIframe path="/demos/bootstrap/5.3/components/toasts/stacking.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/toasts/custom-content-1.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/toasts/custom-content-2.html" >
```html title="HTML"
<div class="toast fade show" role="alert" aria-live="assertive" aria-atomic="true">
    <div class="toast-body">
        ¡Hola Mundo! Este es un mensaje de toast.
...
<DemoIframe path="/demos/bootstrap/5.3/components/toasts/color-schemes.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/toasts/placement-1.html" >
```html title="HTML"
<form>
    <div class="mb-3">
...
<DemoIframe path="/demos/bootstrap/5.3/components/toasts/placement-2.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/toasts/placement-3.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/toasts/accessibility.html" >
```html title="HTML"
