---
title: El componente Progress de Bootstrap
...
head:
  - tag: title
    content: El componente Progress de Bootstrap · Bootstrap en Español v5.3
sidebar:
  label: Progreso
---
...
<DemoIframe path="/demos/bootstrap/5.3/components/progress/how-it-works.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/progress/width.html" >
```html title="HTML"
<div class="progress" role="progressbar" aria-label="Ejemplo básico" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">
...
<DemoIframe path="/demos/bootstrap/5.3/components/progress/height.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/progress/labels-1.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/progress/labels-2.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/progress/backgrounds-1.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/progress/backgrounds-2.html" >
```html title="HTML"
<div class="progress" role="progressbar" aria-label="Ejemplo de éxito" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
...
<DemoIframe path="/demos/bootstrap/5.3/components/progress/backgrounds-3.html" >
```html title="HTML"
<div class="progress" role="progressbar" aria-label="Ejemplo de advertencia" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">
...
<DemoIframe path="/demos/bootstrap/5.3/components/progress/multiple-bars.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/progress/striped.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/progress/animated-stripes.html" >
```html title="HTML"
...
```scss title="scss/_progress.scss"
