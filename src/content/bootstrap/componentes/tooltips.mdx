---
title: El componente Tooltip de Bootstrap
...
head:
  - tag: title
    content: El componente Tooltip de Bootstrap · Bootstrap en Español v5.3
sidebar:
  label: Tooltips
---
...
<DemoIframe path="/demos/bootstrap/5.3/components/tooltips/tooltips-on-links.html" >
```html title="HTML"
<p class="muted">
...
<DemoIframe path="/demos/bootstrap/5.3/components/tooltips/custom-tooltips.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/tooltips/directions-1.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/tooltips/directions-2.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/tooltips/disabled-elements.html" >
```html title="HTML"
