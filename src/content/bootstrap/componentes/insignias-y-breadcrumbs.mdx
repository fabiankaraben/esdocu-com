---
title: Componentes Badge y Breadcrumbs en Bootstrap
description: Documentación y ejemplos para insignias, nuestro componente de etiquetado y recuento.
head:
  - tag: title
    content: El componente de Insignia de Bootstrap · Bootstrap en Español v5.3
sidebar:
  label: Insignias y breadcrumbs
---
...
<DemoIframe path="/demos/bootstrap/5.3/components/badge/examples.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/badge/buttons.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/badge/positioned-1.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/badge/positioned-2.html" >
```html title="HTML"
    <button type="button" class="btn btn-primary position-relative">
        Perfil
        <span
...
<DemoIframe path="/demos/bootstrap/5.3/components/badge/background-colors.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/badge/pill-badges.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/breadcrumb/example.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/breadcrumb/dividers-1.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/breadcrumb/dividers-2.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/breadcrumb/dividers-3.html" >
```html title="HTML"
    <nav style="--bs-breadcrumb-divider: '';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Inicio</a></li>
...
```scss title="scss/_breadcrumb.scss"
