---
title: El componente Offcanvas de Bootstrap
...
head:
  - tag: title
    content: El componente Offcanvas de Bootstrap · Bootstrap en Español v5.3
sidebar:
  label: Offcanvas
---
...
<DemoIframe path="/demos/bootstrap/5.3/components/offcanvas/offcanvas-components.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/offcanvas/live-demo.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/offcanvas/body-scrolling.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/offcanvas/body-scrolling-and-backdrop.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/offcanvas/static-backdrop.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/offcanvas/dark-offcanvas.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/offcanvas/responsive.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/offcanvas/placement-1.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/offcanvas/placement-2.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/offcanvas/placement-3.html" >
```html title="HTML"
...
```scss title="scss/_offcanvas.scss"
