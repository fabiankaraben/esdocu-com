---
title: El componente Tarjeta de Bootstrap
...
head:
  - tag: title
    content: El componente Tarjeta de Bootstrap · Bootstrap en Español v5.3
sidebar:
  label: Tarjetas
---
...
<DemoIframe path="/demos/bootstrap/5.3/components/card/example.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/card/body.html" >
```html title="HTML"
    <div class="card">
        <div class="card-body">
...
<DemoIframe path="/demos/bootstrap/5.3/components/card/titles-text-and-links.html" >
```html title="HTML"
    <div class="card" style="width: 18rem;">
        <div class="card-body">
            <h5 class="card-title">Título de la tarjeta</h5>
...
<DemoIframe path="/demos/bootstrap/5.3/components/card/images.html" >
```html title="HTML"
    <div class="card" style="width: 18rem;">
...
<DemoIframe path="/demos/bootstrap/5.3/components/card/list-groups-1.html" >
```html title="HTML"
    <div class="card" style="width: 18rem;">
...
<DemoIframe path="/demos/bootstrap/5.3/components/card/list-groups-2.html" >
```html title="HTML"
    <div class="card" style="width: 18rem;">
...
<DemoIframe path="/demos/bootstrap/5.3/components/card/list-groups-3.html" >
```html title="HTML"
    <div class="card" style="width: 18rem;">
        <ul class="list-group list-group-flush">
            <li class="list-group-item">Un elemento</li>
...
<DemoIframe path="/demos/bootstrap/5.3/components/card/kitchen-sink.html" >
```html title="HTML"
    <div class="card" style="width: 18rem;">
        <svg class="bd-placeholder-img card-img-top" width="100%" height="180" role="img"
            aria-label="Marcador de posición: Cap de imagen" focusable="false" preserveAspectRatio="xMidYMid slice"
...
<DemoIframe path="/demos/bootstrap/5.3/components/card/header-and-footer-1.html" >
```html title="HTML"
    <div class="card">
        <div class="card-header">
            Destacados
...
<DemoIframe path="/demos/bootstrap/5.3/components/card/header-and-footer-2.html" >
```html title="HTML"
    <div class="card">
...
<DemoIframe path="/demos/bootstrap/5.3/components/card/header-and-footer-3.html" >
```html title="HTML"
    <div class="card">
        <div class="card-header">
            Cita
...
<DemoIframe path="/demos/bootstrap/5.3/components/card/header-and-footer-4.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/card/using-grid-markup.html" >
```html title="HTML"
    <div class="row">
...
<DemoIframe path="/demos/bootstrap/5.3/components/card/using-utilities.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/card/using-custom-css.html" >
```html title="HTML"
    <div class="card" style="width: 18rem;">
        <div class="card-body">
            <h5 class="card-title">Tratamiento especial del título</h5>
...
<DemoIframe path="/demos/bootstrap/5.3/components/card/text-alignment.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/card/navigation-1.html" >
```html title="HTML"
    <div class="card text-center">
        <div class="card-header">
...
<DemoIframe path="/demos/bootstrap/5.3/components/card/navigation-2.html" >
```html title="HTML"
    <div class="card text-center">
        <div class="card-header">
...
<DemoIframe path="/demos/bootstrap/5.3/components/card/image-caps.html" >
```html title="HTML"
    <div class="card mb-3">
        <svg class="bd-placeholder-img card-img-top" width="100%" height="180" role="img"
            aria-label="Marcador de posición: Cap de imagen" focusable="false" preserveAspectRatio="xMidYMid slice"
...
<DemoIframe path="/demos/bootstrap/5.3/components/card/image-overlays.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/card/horizontal.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/card/background-and-color.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/card/border.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/card/mixins-utilities.html" >
```html title="HTML"
    <div class="card border-success mb-3" style="max-width: 18rem;">
...
<DemoIframe path="/demos/bootstrap/5.3/components/card/card-groups-1.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/card/card-groups-2.html" >
```html title="HTML"
    <div class="card-group">
        <div class="card">
            <svg class="bd-placeholder-img card-img-top" width="100%" height="180" role="img"
...
<DemoIframe path="/demos/bootstrap/5.3/components/card/grid-cards-1.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/card/grid-cards-2.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/card/grid-cards-3.html" >
```html title="HTML"
    <div class="row row-cols-1 row-cols-md-3 g-4">
        <div class="col">
...
<DemoIframe path="/demos/bootstrap/5.3/components/card/grid-cards-4.html" >
```html title="HTML"
    <div class="row row-cols-1 row-cols-md-3 g-4">
        <div class="col">
            <div class="card h-100">
