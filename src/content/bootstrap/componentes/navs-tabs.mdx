---
title: Componentes de Navs y pestañas de Bootstrap
description: Documentación y ejemplos sobre cómo usar los componentes de navegación incluidos en Bootstrap.
head:
  - tag: title
    content: Componentes de Navs y pestañas de Bootstrap · Bootstrap en Español v5.3
sidebar:
  label: Navegación y pestañas
---
...
<DemoIframe path="/demos/bootstrap/5.3/components/navs-tabs/base-nav-1.html" >
```html title="HTML"
<ul class="nav">
    <li class="nav-item">
...
<DemoIframe path="/demos/bootstrap/5.3/components/navs-tabs/base-nav-2.html" >
```html title="HTML"
<nav class="nav">
    <a class="nav-link active" aria-current="page" href="#">Activo</a>
    <a class="nav-link" href="#">Enlace</a>
...
<DemoIframe path="/demos/bootstrap/5.3/components/navs-tabs/horizontal-alignment-1.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/navs-tabs/horizontal-alignment-2.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/navs-tabs/vertical-1.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/navs-tabs/vertical-2.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/navs-tabs/tabs.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/navs-tabs/pills.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/navs-tabs/underline.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/navs-tabs/fill-and-justify-1.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/navs-tabs/fill-and-justify-2.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/navs-tabs/fill-and-justify-3.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/navs-tabs/fill-and-justify-4.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/navs-tabs/working-with-flex-utilities.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/navs-tabs/tabs-with-dropdowns.html" >
```html title="HTML"
<ul class="nav nav-tabs">
    <li class="nav-item">
        <a class="nav-link active" aria-current="page" href="#">Activo</a>
...
<DemoIframe path="/demos/bootstrap/5.3/components/navs-tabs/pills-with-dropdowns.html" >
```html title="HTML"
<ul class="nav nav-pills">
    <li class="nav-item">
        <a class="nav-link active" aria-current="page" href="#">Activo</a>
...
<DemoIframe path="/demos/bootstrap/5.3/components/navs-tabs/javascript-behavior-1.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/navs-tabs/javascript-behavior-2.html" >
```html title="HTML"
<nav>
...
<DemoIframe path="/demos/bootstrap/5.3/components/navs-tabs/javascript-behavior-3.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/navs-tabs/javascript-behavior-4.html" >
```html title="HTML"
