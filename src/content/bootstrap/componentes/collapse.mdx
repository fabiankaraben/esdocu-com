...
<DemoIframe path="/demos/bootstrap/5.3/components/collapse/example.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/collapse/horizontal.html" >
```html title="HTML"
<p>
...
<DemoIframe path="/demos/bootstrap/5.3/components/collapse/multiple-toggles-and-targets.html" >
```html title="HTML"
    <p class="d-inline-flex gap-1">
...
```scss title="scss/_transitions.scss"
.collapse {
    &:not(.show) {
    display: none;
    }
