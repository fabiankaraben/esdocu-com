---
title: Marcadores de posición y paginación
...
head:
  - tag: title
    content: Componentes Marcadores de posición de Bootstrap · Bootstrap en Español v5.3
sidebar:
  label: Marcadores de posición y paginación
---
...
<DemoIframe path="/demos/bootstrap/5.3/components/placeholders/example.html" >
```html title="HTML"
<div class="card">
...
<DemoIframe path="/demos/bootstrap/5.3/components/placeholders/how-it-works.html" >
```html title="HTML"
<p aria-hidden="true">
    <span class="placeholder col-6"></span>
</p>
...
<DemoIframe path="/demos/bootstrap/5.3/components/placeholders/width.html" >
```html title="HTML"
<span class="placeholder col-6"></span>
...
<DemoIframe path="/demos/bootstrap/5.3/components/placeholders/color.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/placeholders/sizing.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/placeholders/animation.html" >
```html title="HTML"
...
```scss title="scss/_pagination.scss"
...
```scss title="scss/mixins/_pagination.scss"
