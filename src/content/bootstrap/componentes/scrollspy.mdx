---
title: El componente Scrollspy de Bootstrap
...
head:
  - tag: title
    content: El componente Scrollspy de Bootstrap · Bootstrap en Español v5.3
sidebar:
  label: Scrollspy
---
...
<DemoIframe path="/demos/bootstrap/5.3/components/scrollspy/navbar.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/scrollspy/nested-nav.html" >
```html title="HTML"
<div class="row">
    <div class="col-4">
...
<DemoIframe path="/demos/bootstrap/5.3/components/scrollspy/list-group.html" >
```html title="HTML"
<div class="row">
    <div class="col-4">
...
<DemoIframe path="/demos/bootstrap/5.3/components/scrollspy/simple-anchors.html" >
```html title="HTML"
<div class="row">
    <div class="col-4">
