---
title: El componente Carrusel de Bootstrap
...
head:
  - tag: title
    content: El componente Carrusel de Bootstrap · Bootstrap en Español v5.3
sidebar:
  label: Carrusel
---
...
<DemoIframe path="/demos/bootstrap/5.3/components/carousel/basic-examples.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/carousel/indicators.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/carousel/captions.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/carousel/crossfade.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/carousel/autoplaying-carousels-1.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/carousel/autoplaying-carousels-2.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/carousel/individual-carousel-item-interval.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/carousel/autoplaying-carousels-without-controls.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/carousel/disable-touch-swiping.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/carousel/dark-variant.html" >
```html title="HTML"
