---
title: Utilidades helpers en Bootstrap
description: Borra rápida, posiciona o aplica formato fácilmente al contenido utilizando una estas utilidades.
head:
  - tag: title
    content: Uso de ayudantes o helpers de Bootstrap · Bootstrap en Español v5.3
sidebar:
  label: Helpers de Bootstrap
---
...
```scss title="scss/mixins/_clearfix.scss"
@mixin clearfix() {
  &::after {
    display: block;
    clear: both;
...
<DemoIframe path="/demos/bootstrap/5.3/helpers/color-background/overview.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/helpers/color-background/with-components-1.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/helpers/color-background/with-components-2.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/helpers/colored-links/link-colors.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/helpers/colored-links/link-utilities.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/helpers/focus-ring/example.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/helpers/focus-ring/css-variables-1.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/helpers/focus-ring/css-variables-2.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/helpers/focus-ring/sass-utilities-api.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/helpers/icon-link/example-1.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/helpers/icon-link/example-2.html" >
```html title="HTML"
    <a class="icon-link" href="#">
        Enlace de ícono
        <svg class="bi" aria-hidden="true">
...
<DemoIframe path="/demos/bootstrap/5.3/helpers/icon-link/style-on-hover.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/helpers/icon-link/css-variables-1.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/helpers/icon-link/css-variables-2.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/helpers/icon-link/sass-utilities-api.html" >
```html title="HTML"
...
```scss title="scss/helpers/_stacks.scss"
.hstack {
    display: flex;
    flex-direction: row;
    align-items: center;
...
<DemoIframe path="/demos/bootstrap/5.3/helpers/stretched-link/index-1.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/helpers/stretched-link/index-2.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/helpers/stretched-link/index-3.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/helpers/stretched-link/identifying-the-containing-block.html" >
```html title="HTML"
    <div class="card" style="width: 18rem;">
        <svg class="bd-placeholder-img card-img-top" width="100%" height="180" role="img"
            aria-label="Cap de imagen de tarjeta" focusable="false" preserveAspectRatio="xMidYMid slice"
