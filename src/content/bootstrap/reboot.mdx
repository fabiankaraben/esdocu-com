---
title: Uso de la biblioteca Reboot en Bootstrap
...
head:
  - tag: title
    content: Uso de la biblioteca Reboot en Bootstrap · Bootstrap en Español v5.3
sidebar:
  label: Uso de Reboot en Boostrap
---
...
<DemoIframe path="/demos/bootstrap/5.3/content/reboot/paragraphs.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/content/reboot/links-1.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/content/reboot/links-2.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/content/reboot/links-3.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/content/reboot/horizontal-rules.html" >
```html title="HTML"
    <hr>
...
<DemoIframe path="/demos/bootstrap/5.3/content/reboot/lists-1.html" >
```html title="HTML"
<ul>
...
<DemoIframe path="/demos/bootstrap/5.3/content/reboot/lists-2.html" >
```html title="HTML"
    <dl>
...
<DemoIframe path="/demos/bootstrap/5.3/content/reboot/inline-code.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/content/reboot/code-blocks.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/content/reboot/variables.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/content/reboot/user-input.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/content/reboot/sample-output.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/content/reboot/tables.html" >
```html title="HTML"
<table>
    <caption>
...
<DemoIframe path="/demos/bootstrap/5.3/content/reboot/forms.html" >
</DemoIframe>
...
<DemoIframe path="/demos/bootstrap/5.3/content/reboot/pointers-on-buttons.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/content/reboot/misc-elements.html" >
```html title="HTML"
<address>
...
<DemoIframe path="/demos/bootstrap/5.3/content/reboot/blockquote.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/content/reboot/inline-elements.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/content/reboot/summary.html" >
```html title="HTML"
<details>
