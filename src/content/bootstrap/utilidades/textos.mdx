---
title: Uso de las utilidades de Texto en Bootstrap
description: Documentación y ejemplos de utilidades de texto comunes para controlar la alineación, el ajuste, el peso y más.
head:
  - tag: title
    content: Uso de las utilidades de Texto en Bootstrap · Bootstrap en Español v5.3
sidebar:
  label: Utilidades para textos
---
...
<DemoIframe path="/demos/bootstrap/5.3/utilities/text/text-alignment.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/utilities/text/text-wrapping-and-overflow-1.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/utilities/text/text-wrapping-and-overflow-2.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/utilities/text/word-break.html" >
```html title="HTML"
    <p class="text-break">
...
<DemoIframe path="/demos/bootstrap/5.3/utilities/text/text-transform.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/utilities/text/font-size.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/utilities/text/font-weight-and-italics.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/utilities/text/line-height.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/utilities/text/monospace.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/utilities/text/reset-color.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/utilities/text/text-decoration.html" >
```html title="HTML"
