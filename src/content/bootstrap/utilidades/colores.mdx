---
title: Uso de las utilidades de Colores en Bootstrap
...
head:
  - tag: title
    content: Uso de las utilidades de Colores en Bootstrap · Bootstrap en Español v5.3
sidebar:
  label: Utilidades de colores
---
...
<DemoIframe path="/demos/bootstrap/5.3/utilities/colors/colors.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/utilities/colors/example-1.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/utilities/colors/example-2.html" >
```html title="HTML"
    <div class="text-primary">Este es el texto principal predeterminado</div>
