---
title: El componente Acordeón de Bootstrap
...
head:
  - tag: title
    content: El componente Acordeón de Bootstrap · Bootstrap en Español v5.3
sidebar:
  label: Acordeón
---
...
<DemoIframe path="/demos/bootstrap/5.3/components/accordion/example.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/accordion/flush.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/accordion/always-open.html" >
```html title="HTML"
...
```scss title="scss/_accordion.scss"
