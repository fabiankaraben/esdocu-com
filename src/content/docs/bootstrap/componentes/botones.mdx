---
title: Componentes de Botones de Bootstrap
...
head:
  - tag: title
    content: Componentes de Botones de Bootstrap · Bootstrap en Español v5.3
sidebar:
  label: Botones
---
...
<DemoIframe path="/demos/bootstrap/5.3/components/buttons/base-class.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/buttons/variants.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/buttons/button-tags.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/buttons/outline-buttons.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/buttons/sizes-1.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/buttons/sizes-2.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/buttons/sizes-3.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/buttons/disabled-state-1.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/buttons/disabled-state-2.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/buttons/link-functionality-caveat.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/buttons/block-buttons-1.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/buttons/block-buttons-2.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/buttons/block-buttons-3.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/buttons/block-buttons-4.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/buttons/toggle-states-1.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/buttons/toggle-states-2.html" >
```html title="HTML"
    <p class="d-inline-flex gap-1">
...
<DemoIframe path="/demos/bootstrap/5.3/components/buttons/variables.html" >
</DemoIframe>

[site/assets/scss/_buttons.scss](https://github.com/twbs/bootstrap/blob/v5.3.2/site/assets/scss/_buttons.scss)

```scss title="site/assets/scss/_buttons.scss"
.btn-bd-primary {
...
```scss title="scss/mixins/_buttons.scss"
...
<DemoIframe path="/demos/bootstrap/5.3/components/close-button/example.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/close-button/disabled-state.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/close-button/dark-variant.html" >
```html title="HTML"
