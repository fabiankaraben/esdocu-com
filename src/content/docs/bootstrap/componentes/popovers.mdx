---
title: El componente Popover de Bootstrap
...
head:
  - tag: title
    content: El componente Popover de Bootstrap · Bootstrap en Español v5.3
sidebar:
  label: Popovers
---
...
<DemoIframe path="/demos/bootstrap/5.3/components/popovers/live-demo.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/popovers/four-directions.html" >
```html title="HTML"
...
```scss title="site/assets/scss/_component-examples.scss"
.custom-popover {
...
<DemoIframe path="/demos/bootstrap/5.3/components/popovers/custom-popovers.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/popovers/dismiss-on-next-click.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/popovers/disabled-elements.html" >
```html title="HTML"
