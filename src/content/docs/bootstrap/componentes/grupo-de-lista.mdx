---
title: El componente Grupo de lista de Bootstrap
...
head:
  - tag: title
    content: El componente Grupo de lista de Bootstrap · Bootstrap en Español v5.3
sidebar:
  label: Grupo de lista
---
...
<DemoIframe path="/demos/bootstrap/5.3/components/list-group/basic-example.html" >
```html title="HTML"
<ul class="list-group">
...
<DemoIframe path="/demos/bootstrap/5.3/components/list-group/active-items.html" >
```html title="HTML"
<ul class="list-group">
...
<DemoIframe path="/demos/bootstrap/5.3/components/list-group/disabled-items.html" >
```html title="HTML"
<ul class="list-group">
    <li class="list-group-item active" aria-current="true">Un elemento activo</li>
    <li class="list-group-item">Un segundo elemento</li>
...
<DemoIframe path="/demos/bootstrap/5.3/components/list-group/links-and-buttons-1.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/list-group/links-and-buttons-2.html" >
```html title="HTML"
<div class="list-group">
...
<DemoIframe path="/demos/bootstrap/5.3/components/list-group/flush.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/list-group/numbered-1.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/list-group/numbered-2.html" >
```html title="HTML"
<ol class="list-group list-group-numbered">
...
<DemoIframe path="/demos/bootstrap/5.3/components/list-group/horizontal.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/components/list-group/variants.html" >
```html title="HTML"
<ul class="list-group">
...
<DemoIframe path="/demos/bootstrap/5.3/components/list-group/for-links-and-buttons.html" >
```html title="HTML"
<div class="list-group">
...
<DemoIframe path="/demos/bootstrap/5.3/components/list-group/with-badges.html" >
```html title="HTML"
<ul class="list-group">
...
<DemoIframe path="/demos/bootstrap/5.3/components/list-group/custom-content.html" >
```html title="HTML"
<div class="list-group">
    <a href="#" class="list-group-item list-group-item-action active" aria-current="true">
...
<DemoIframe path="/demos/bootstrap/5.3/components/list-group/checkboxes-and-radios-1.html" >
```html title="HTML"
<ul class="list-group">
...
<DemoIframe path="/demos/bootstrap/5.3/components/list-group/checkboxes-and-radios-2.html" >
```html title="HTML"
<ul class="list-group">
    <li class="list-group-item">
...
<DemoIframe path="/demos/bootstrap/5.3/components/list-group/checkboxes-and-radios-3.html" >
```html title="HTML"
<ul class="list-group">
    <li class="list-group-item">
...
```scss title="scss/mixins/_list-group.scss"
...
<DemoIframe path="/demos/bootstrap/5.3/components/list-group/javascript-behavior.html" >
```html title="HTML"
<div class="row">
    <div class="col-4">
