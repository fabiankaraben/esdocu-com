---
title: Uso de la cuadrícula CSS (CSS Grid) de Bootstrap
...
head:
  - tag: title
    content: Uso de la cuadrícula CSS (CSS Grid) de Bootstrap · Bootstrap en Español v5.3
sidebar:
  label: Uso de la grilla CSS
---
...
<DemoIframe path="/demos/bootstrap/5.3/layout/css-grid/three-columns.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/layout/css-grid/responsive-1.html" >
```html title="HTML"
    <div class="grid text-center">
...
<DemoIframe path="/demos/bootstrap/5.3/layout/css-grid/responsive-2.html" >
```html title="HTML"
    <div class="grid text-center">
...
<DemoIframe path="/demos/bootstrap/5.3/layout/css-grid/wrapping.html" >
```html title="HTML"
    <div class="grid text-center">
        <div class="g-col-6">.g-col-6</div>
        <div class="g-col-6">.g-col-6</div>
...
<DemoIframe path="/demos/bootstrap/5.3/layout/css-grid/starts.html" >
```html title="HTML"
    <div class="grid text-center">
...
<DemoIframe path="/demos/bootstrap/5.3/layout/css-grid/auto-columns-1.html" >
```html title="HTML"
    <div class="grid text-center">
        <div>1</div>
        <div>1</div>
...
<DemoIframe path="/demos/bootstrap/5.3/layout/css-grid/auto-columns-2.html" >
```html title="HTML"
    <div class="grid text-center">
        <div class="g-col-6">.g-col-6</div>
        <div>1</div>
...
<DemoIframe path="/demos/bootstrap/5.3/layout/css-grid/nesting.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/layout/css-grid/no-grid-classes.html" >
```html title="HTML"
    <div class="grid text-center" style="--bs-columns: 3;">
        <div>Auto-column</div>
        <div>Auto-column</div>
...
<DemoIframe path="/demos/bootstrap/5.3/layout/css-grid/columns-and-gaps-1.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/layout/css-grid/columns-and-gaps-2.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/layout/css-grid/adding-rows.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/layout/css-grid/gaps-1.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/layout/css-grid/gaps-2.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/layout/css-grid/sass.html" >
```html title="HTML"
