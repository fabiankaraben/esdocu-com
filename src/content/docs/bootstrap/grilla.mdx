---
title: El sistema de cuadrícula de Bootstrap
...
head:
  - tag: title
    content: El sistema de cuadrícula de Bootstrap · Bootstrap en Español v5.3
sidebar:
  label: Sistema de grilla
---
...
<DemoIframe path="/demos/bootstrap/5.3/layout/grid/example.html" >
```html title="HTML"
...
<DemoIframe path="/demos/bootstrap/5.3/layout/grid/equal-width.html" >
```html title="HTML"
    <div class="container text-center">
        <div class="row">
            <div class="col">
...
<DemoIframe path="/demos/bootstrap/5.3/layout/grid/setting-one-column-width.html" >
```html title="HTML"
    <div class="container text-center">
        <div class="row">
            <div class="col">
...
<DemoIframe path="/demos/bootstrap/5.3/layout/grid/variable-width-content.html" >
```html title="HTML"
    <div class="container text-center">
...
<DemoIframe path="/demos/bootstrap/5.3/layout/grid/all-breakpoints.html" >
```html title="HTML"
    <div class="container text-center">
        <div class="row">
...
<DemoIframe path="/demos/bootstrap/5.3/layout/grid/stacked-to-horizontal.html" >
```html title="HTML"
    <div class="container text-center">
        <div class="row">
...
<DemoIframe path="/demos/bootstrap/5.3/layout/grid/mix-and-match.html" >
```html title="HTML"
    <div class="container text-center">
...
<DemoIframe path="/demos/bootstrap/5.3/layout/grid/row-columns-1.html" >
```html title="HTML"
    <div class="container text-center">
...
<DemoIframe path="/demos/bootstrap/5.3/layout/grid/row-columns-2.html" >
```html title="HTML"
    <div class="container text-center">
...
<DemoIframe path="/demos/bootstrap/5.3/layout/grid/row-columns-3.html" >
```html title="HTML"
    <div class="container text-center">
...
<DemoIframe path="/demos/bootstrap/5.3/layout/grid/row-columns-4.html" >
```html title="HTML"
    <div class="container text-center">
...
<DemoIframe path="/demos/bootstrap/5.3/layout/grid/row-columns-5.html" >
```html title="HTML"
    <div class="container text-center">
        <div class="row row-cols-4">
            <div class="col">Columna</div>
...
<DemoIframe path="/demos/bootstrap/5.3/layout/grid/row-columns-6.html" >
```html title="HTML"
    <div class="container text-center">
...
<DemoIframe path="/demos/bootstrap/5.3/layout/grid/nesting.html" >
```html title="HTML"
    <div class="container text-center">
        <div class="row">
            <div class="col-sm-3">
...
<DemoIframe path="/demos/bootstrap/5.3/layout/grid/example-usage.html" >
```html title="HTML"
