---
title: Cómo utilizar Moment.js
description: Moment.js fue diseñado para funcionar tanto en el navegador como en Node.js. Aprende a instalar y utilizar Moment en distintas tecnologías como Node.js, Bower, Webpack, TypeScript y más.
head:
  - tag: title
    content: Cómo utilizar Moment.js y sus opciones de integración · Moment.js en Español
sidebar:
  label: Uso de Moment.js
---
...
```sh title="Terminal (Instalación con NPM)"
npm install moment
```
